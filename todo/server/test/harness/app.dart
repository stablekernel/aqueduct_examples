...
///
/// Use instances of this class to start/stop the test todo server. Use [client] to execute
...
class TestApplication {
  ...
  Application<TodoSink> application;
  TodoSink get sink => application.mainIsolateSink;
  TestClient client;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [TodoSink].
  /// The declared [ManagedObject]s in this application will be
  /// used to generate a temporary database schema. The [TodoSink] instance will use
  ...
  Future start() async {
    ...
    application = new Application<TodoSink>();
